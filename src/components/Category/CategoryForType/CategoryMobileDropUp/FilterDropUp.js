                ...
                <ul>
                  <li className="w-full text-[#303030] text-base font-AeonikProRegular">
                    ...
                    >
                      <div className="w-full flex flex-wrap justify-between items-center gap-y-2 gap-x-2">
                        {products?.genders.map((data, index) => {
                          return (
                            <div
                              key={index}
                              className={`${
                                data.id === 4 ? "text-red-600" : "text-black"
                              } w-[48.8%] h-10 rounded-lg flex flex-row items-center justify-center border border-[#dcdce1] hover:text-white focus:bg-fullBlue hover:bg-fullBlue focus:text-white cursor-pointer `}
                  ...
                  <li className="w-full text-[#303030] text-base font-AeonikProRegular">
                    ...
                    >
                      <figure
                        onClick={() =>
                          setState({ ...state, catolog: !state.catolog })
                        }
                        className="w-full flex items-center justify-between cursor-pointer select-none border-b border-searchBgColor"
                      >
                        <p className="not-italic font-AeonikProRegular leading-4 mb-3">
                    ...
                    >
                      {products?.Catolog.map((data, index) => {
                        return (
                          <figure
                            key={index}
                  ...
                  <li className="w-full text-[#303030] text-base font-AeonikProRegular">
                    ...
                    >
                      ...
                      >
                        {products?.brandWear.map((data, index) => {
                          return (
                            <div
                              key={index}
                      ...
                      <figure className="w-full h-12 mt-2 pb-1 px-[2px]">
                        <div className=" w-full flex justify-between items-center gap-x-1">
                          <div className=" h-fit  font-AeonikProRegular text-sm leading-4 tracking-[1%]">
                            от
                            <span className="text-lg mr-[2px] ml-[5px]">
                              {values[0]}
                            </span>
                            сум
                          </div>
