...
export default function ShopOfficialCard({ filteredData, setPageId }) {
  ...
  return (
    <div className="flex flex-col box-border">
      {
        filteredData?.products?.data?.length > 0 ? <div className="flex justify-start flex-wrap gap-x-2 gap-y-2">
      ...
      {
        filteredData?.products?.data?.length > 0 && <div className="w-full hidden h-fit md:flex items-center justify-center mt-[75px] gap-x-6">
          <article className="flex items-center">
