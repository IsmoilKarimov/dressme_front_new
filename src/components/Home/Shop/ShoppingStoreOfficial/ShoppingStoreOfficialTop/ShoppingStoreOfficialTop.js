...
import LocationDropUp from "./LocationDropUp";
          ...
          <div className="w-full flex flex-col border-[#F0F0F0] mt-4 md:mt-0">
            ...
            >
              ...
              <div className="w-full md:w-[35%] hidden md:flex items-center border-t md:border-none border-searchBgColor mt-5 pt-5 md:pt-0 md:mt-0">
                ...
                >
                  <span onClick={() => setOpenLocationModal(true)} className="flex items-center justify-center min-w-12 min-h-12 w-12 h-12 rounded-xl border border-searchBgColor cursor-pointer">
                  ...
                  {filteredData?.shop?.approved_shop_locations
                    ...
                    ?.map((item, index) => {
                      return (
                        <p
                          key={index}
                          className="text-sm font-AeonikProRegular text-borderWinter"
                        >
                          {item?.address}
                        </p>
                      );
              ...
              <div className="w-full md:hidden flex items-center border-b md:border-none border-searchBgColor py-3">
                ...
                >
                  <span className="flex items-center justify-center min-w-[38px] min-h-[38px]  rounded-xl border border-searchBgColor cursor-pointer">
                    <LocationColoursIcons colors={"#007DCA"} />
                  </span>
                  {filteredData?.shop?.approved_shop_locations
                    ?.filter(
                    ...
                    ?.map((item, index) => {
                      return (
                        <p
                          key={index}
                          className="text-[12px] xs:text-sm  font-AeonikProRegular text-borderWinter"
                        >
                          {item?.address}
                        </p>
                      );
