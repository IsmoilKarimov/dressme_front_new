                  ...
                  >
                    ...
                    <div className="w-full flex flex-row-reverse md:flex-row items-center md:ml-auto justify-between md:justify-start mt-3 md:mt-0">
                      ...
                      <div className="flex items-center md:ml-[88px] md:mt-0">
                        ...
                        <div className="flex w-9 h-9 md:w-12 md:h-12 items-center justify-center border border-searchBgColor bg-btnBgColor md:bg-white rounded-lg mr-1">
                          <ManGenIcons />
                        </div>
                ...
                >
                  ...
                  <div className="w-full flex flex-row-reverse md:flex-row items-center md:ml-auto justify-between md:justify-start mt-3 md:mt-0">
                    ...
                    <div className="flex items-center md:ml-[88px] md:mt-0">
                      ...
                      <div className={`${data.gender_id === "1" ? 'flex w-9 h-9 md:w-12 md:h-12 items-center justify-center border border-searchBgColor bg-btnBgColor md:bg-white rounded-lg mr-1' : 'hidden' } `}>
                        <ManGenIcons />
                      </div>
                      
                      <div className={`${data.gender_id === "2" ? 'flex items-center justify-center border border-searchBgColor bg-btnBgColor md:bg-white w-9 h-9 md:w-12 md:h-12 rounded-lg' : 'hidden'} `}>
                        <WomanGenIcons />
                      </div>
