...
function CategoryUnderwearSizesFilter({
  state,
  setState,
  filter,
                ...
                return (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span className={`${dataActionUnderwearSizes === index ? 'block' : 'hidden'} ml-1`}>({filterData?.category_products?.total || 0})</span>
                    </div>
                  </button>
                );
              })}
...
export default React.memo(CategoryUnderwearSizesFilter);
