  ...
  return (
    <div className={`w-full`}>
        ...
        <div className="w-full flex justify-end">
            <NavLink to='/delivery-points' className={"px-5 py-3 bg-borderWinter text-white font-AeonikProMedium text-base mt-[15px] rounded-lg"}>Открыть на яндекс карте</NavLink>
        </div>
    </div>
  );
}
