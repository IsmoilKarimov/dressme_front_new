            ...
            <section className="w-full h-[280px] pl-4 flex flex-col flex-nowrap">
                <action className="w-full flex flex-row flex-nowrap gap-y-[10px] gap-x-[12px] mb-4">
                    ...
                    <div className='w-[58%] pb-2 bg-[#F7F8FC] rounded-l-lg flex flex-col'>
                        ...
                        <div className='w-full pl-[12px] pr-6 ml-[5px] rounded-l overflow-hidden bg-[#fdfdfd] h-10 text-[13px] font-AeonikProRegular flex items-center justify-between'>
                            <span>XXS</span>
                            <span>XS</span>
                            <span>S</span>
                            <span>M</span>
                        ...
                        <div className='w-full pl-[8px] ml-[5px] rounded-l overflow-hidden bg-[#fdfdfd] h-10 text-[13px] font-AeonikProRegular flex items-center justify-between'>
                            <span>45-52</span>
                            <span>24-35</span>
                            <span>13-18</span>
                            <span>35-41</span>
                        ...
                        <div className='w-full bg-[#fdfdfd] pr-4 pl-[8px] ml-[5px] rounded-l overflow-hidden h-10 text-[13px] font-AeonikProRegular flex items-center justify-between'>
                            <span>45-52</span>
                            <span>24-35</span>
                            <span>13-18</span>
                            <span>35-41</span>
