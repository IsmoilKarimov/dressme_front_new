      ...
      <div className="max-w-[1280px] w-[100%] flex justify-between items-center m-auto px-4 md:px-0">
        <div className="w-[100%] h-10 md:w-fit  flex items-center  overflow-x-auto">
          ...
          <div className="not-italic font-AeonikProRegular flex items-center  text-sm leading-4 text-black tracking-[1%] mr-[10px]">
            <NavLink
              to="/basket-check-out"
              className="flex items-center cursor-pointer mt-[6px] pr-[10px] not-italic font-AeonikProMedium text-sm leading-4 text-black tracking-[1%]"
            >
              Корзинка{" "}
            </NavLink>
            <span>
          ...
          <div className="not-italic font-AeonikProRegular flex items-center  text-sm leading-4 text-black tracking-[1%] mr-[10px]">
            <NavLink
              to="/basket-check-out"
              className="flex items-center cursor-pointer whitespace-nowrap mt-[6px] pr-[10px] not-italic font-AeonikProMedium text-sm leading-4 text-black tracking-[1%]"
            >
              Оформление заказа{" "}
            </NavLink>
            <span>
